...
QRectF CityPump::boundingRect() const
{
    return QRectF(-20, -20, 40, 40);
}

void CityPump::paint(QPainter *painter,
                      ...
                      QWidget * /* widget */)
{
    ...
    if (zoom < 4.0) {
        ...
        painter->drawLine(-9, 1, 0, -8);
        painter->drawLine( 0,-8, 9,  1);
        //painter->drawLine(  0, 1, 5,-5);
        //painter->drawLine( 5, -5, 5,5);

    }
}
void CityPump::mousePressEvent(QGraphicsSceneMouseEvent *event)
{
    ...
    std::cout << "CityPump   colorid .......... " << colorid << "\n";
...
void CityPump::mouseReleaseEvent(QGraphicsSceneMouseEvent *event)
{
    //Pressed = false;
    update();
